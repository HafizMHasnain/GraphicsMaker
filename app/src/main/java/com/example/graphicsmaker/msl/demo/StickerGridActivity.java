...
import com.example.graphicsmaker.msl.demo.NetworkQueryHelper.ResponseListener;
...
public class StickerGridActivity extends Activity {
    ...
    private void initUI() {
      ...
      //  this.tabHost.setDividerWidth(dpToPx(this, 1));
        ...
        this.tabHost.setOnPageChangeListener(new OnPageChangeListener() {
    ...
    private void checkDataVersionChanges() {
        ...
        NetworkQueryHelper.getInstance().getServerDbVersion(new ResponseListener() {
    ...
    private void fetchAndInsertCategory() {
        NetworkQueryHelper.getInstance().getCategoriesData(this.categoriesCount, new ResponseListener() {
