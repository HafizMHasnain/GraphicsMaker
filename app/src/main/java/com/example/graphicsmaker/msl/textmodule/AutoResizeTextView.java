...
public class AutoResizeTextView extends AppCompatTextView {
        ...
        this._sizeTester = new SizeTester() {
            ...
            public int onTestSize(int suggestedSize, RectF availableSpace) {
                ...
                if (AutoResizeTextView.this.getMaxLines() == 1) {
                    ...
                    StaticLayout layout = new StaticLayout(text, AutoResizeTextView.this._paint, AutoResizeTextView.this._widthLimit, Alignment.ALIGN_CENTER, AutoResizeTextView.this._spacingMult, AutoResizeTextView.this._spacingAdd, true);
    ...
    private void drawTextView(Canvas canvas) {
        ...
        float measureText = getPaint().measureText(textString);
