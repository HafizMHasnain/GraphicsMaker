...
public class TextInfo {
    ...
    public TextInfo(int TEMPLATE_ID, String TEXT, String FONT_NAME, int TEXT_COLOR, int TEXT_ALPHA, int SHADOW_COLOR, int SHADOW_PROG, String BG_DRAWABLE, int BG_COLOR, int BG_ALPHA, float POS_X, float POS_Y, int WIDTH, int HEIGHT, float ROTATION, String TYPE, int ORDER, int XRotateProg, int YRotateProg, int ZRotateProg, int CurveRotateProg, int field_one, String field_two, String field_three, String field_four, String gravity) {
    ...
    public void setTEXT_GRAVITY(String TEXT_GRAVITY) {
        this.TEXT_GRAVITY = TEXT_GRAVITY;
    }
}
