...
import com.example.graphicsmaker.msl.demo.HttpRequestTask.RequestListener;
...
public class NetworkQueryHelper {
    ...
    public void getServerDbVersion(final ResponseListener listener) {
        ...
        }).execute(Arrays.toString(new String[]{getDataVersionURL()}));
    }
    ...
    public void getCategoriesData(int categoriesCount, final ResponseListener listener) {
        ...
        }).execute(Arrays.toString(new String[]{getFetchCategoryURL(categoriesCount)}));
    }
    ...
    public void getStickersData(String categoryName, int sequenceNum, int pageSize, final ResponseListener listener) {
        ...
        }).execute(Arrays.toString(new String[]{getFetchStickerDataURL(categoryName, sequenceNum, pageSize)}));
    }
